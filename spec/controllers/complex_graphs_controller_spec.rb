...
describe ComplexGraphsController do
  ...
  # ComplexGraph. As you add validations to ComplexGraph, be sure to
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested complex_graph" do
        ...
        ComplexGraph.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => complex_graph.to_param, :complex_graph => {'these' => 'params'}}, valid_session
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the complex_graphs list" do
      complex_graph = ComplexGraph.create! valid_attributes
      delete :destroy, {:id => complex_graph.to_param}, valid_session
      response.should redirect_to(complex_graphs_url)
    end
  end
